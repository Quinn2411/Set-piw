...
def find_one_set(A):
    for i, card1 in enumerate(A._table): # making use of enumerate to skip checking duplicates (if card1, card2, card3 is checked we dont check card1, card3 ,card2 aswell)
